...
export default function CreateCampsite() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success(t('admin.campsites.createSuccess'))
    ...
    <AdminLayout>
      <div className="space-y-6">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900">{t('admin.campsites.addNew')}</h1>
            <p className="mt-1 text-sm text-gray-600">Create a new campsite listing</p>
          </div>
        </div>
